...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ isset($articles) && $articles->status == 'published' ? route('articles.index') : route('drafts.index') }}" class="btn btn-secondary btn-sm mt-3">back</a>
    </div>
    <div class="row">
        <div class="col-md-12">
            @if(isset($articles))
                ...
                <div class="card mb-4 p-3 shadow-sm">
                    ...
                    <div class="col-md-3">
                        <img src="{{ asset('storage/articles/' . basename($articles->image)) }}" alt="Article Image" class="img-fluid rounded" style="max-width: 150px;">
                    </div>
                    <div class="col-md-9">
                        <div class="card-body">
